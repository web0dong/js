...
"offsetTop", "offsetParent", "tagName", "BODY", "offsetLeft", "pageX", "pageY", "clientX", "clientY", "scrollLeft", "body", "documentElement", "scrollTop", 'Created by <a href="http://mkienthuc.blogspot.com">Leo Nguyen</a>', "#web0dongcopyright", "#web0dongcopyright:visible", "href", "location", "http://mkienthuc.blogspot.com", "ready"];
/**
 * @param {?} startEvent
 * @param {number} w
 * @param {number} h
